...
// 	$passwordR = mysqli_escape_string($conexion,$_POST['passr']);
// 	$password_encriptada = sha1($password);
// 	$sqluser = "SELECT id FROM usuarios WHERE usuarios = '$usuario'";
...
// 			  </script>"
// 	}else{
// 		$sqlusuario = "INSERT INTO usuarios(nombre,correo,usuario,contraseña) VALUES ()";
// 	}
